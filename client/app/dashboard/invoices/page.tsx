          ...
          <Table>
             ...
             <TableBody>
                {isLoading ? (
                   ...
                   invoices.map((inv) => (
                      <TableRow key={inv.id} className="border-white/[0.05] hover:bg-white/[0.02] transition-colors">
                         ...
                         <TableCell>
                            <span className={`px-2 py-0.5 rounded-sm text-[10px] font-bold uppercase tracking-wider ${
                               inv.status === 'Draft' ? 'bg-neutral-800 text-neutral-400' :
                         ...
                         <TableCell className="text-right space-x-2">
                             ...
                             {inv.payment_url ? (
                                ...
                                <button onClick={() => generatePaymentLink(inv.id)} className="inline-flex h-8 items-center justify-center rounded-md border border-white/10 bg-transparent px-3 text-xs font-medium hover:bg-white/[0.03] transition-colors text-neutral-400">
