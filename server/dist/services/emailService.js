...
export const sendOverdueEmail = async (clientEmail, clientName, invoiceNumber, amount, paymentUrl) => {
    try {
        if (!clientEmail) {
...
export const sendReminderEmail = async (clientEmail, clientName, invoiceNumber, amount, dueDate, paymentUrl, type) => {
    try {
        if (!clientEmail) {
...
export const sendVerificationEmail = async (clientEmail, name, token) => {
    try {
...
export const sendResetEmail = async (clientEmail, name, token) => {
    try {
